...
import { ForbiddenWordMetaData } from 'src/domain/forbidden-words/forbidden-word.metadata';
import { ForbiddenWord } from 'src/domain/forbidden-words/forbidden-word.type';
